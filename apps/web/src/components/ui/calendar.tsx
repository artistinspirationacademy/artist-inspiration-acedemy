...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn(
                "group/calendar bg-background p-3 text-white [--cell-radius:var(--radius-md)] [--cell-size:--spacing(9)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    "size-(--cell-size) p-0 text-white/70 select-none hover:bg-white/10 hover:text-white aria-disabled:opacity-50",
                ...
                caption_label: cn(
                    ...
                    captionLayout === "label"
                        ? "text-sm"
                        : "flex items-center gap-1 rounded-(--cell-radius) text-sm [&>svg]:size-3.5 [&>svg]:text-white/60",
                ...
                week_number: cn(
                    "text-[0.75rem] text-white/40 select-none",
