...
import { DEFAULT_PAGINATION, Icons, Package } from "@workspace/config";
...
export function PackageAction({ data, onDelete }: PageProps) {
    ...
    const { usePaginate, useDelete } = usePackage();
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Deleting this package will permanently remove it and
