...
import { Banner, DEFAULT_PAGINATION, Icons } from "@workspace/config";
...
export function BannerAction({ data, onDelete }: PageProps) {
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuGroup>
                        <DropdownMenuItem
                            onClick={() =>
                                router.push(`/banners/${data.id}/edit`)
                            }
                        >
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Deleting this banner will permanently remove it and
