...
import { DEFAULT_PAGINATION, Icons, Platform } from "@workspace/config";
...
export function PlatformAction({ data, onDelete }: PageProps) {
    ...
    const { usePaginate, useDelete } = usePlatform();
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuGroup>
                        <DropdownMenuItem
                            onClick={() =>
                                router.push(`/platforms/${data.id}/edit`)
                            }
                        >
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Deleting this platform will permanently remove it
