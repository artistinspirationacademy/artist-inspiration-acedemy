...
export function TestimonialAction({ data, onDelete }: PageProps) {
    ...
    const { usePaginate, useDelete } = useTestimonial();
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuGroup>
                        <DropdownMenuItem
                            onClick={() =>
                                router.push(`/testimonials/${data.id}/edit`)
                            }
                        >
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            ...
                            {data.name}&rdquo;&apos;s testimonial?
                        </AlertDialogTitle>

                        <AlertDialogDescription>
                            Deleting this testimonial will permanently remove
