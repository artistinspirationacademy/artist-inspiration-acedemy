...
function SideNav({ className, ...props }: GenericProps) {
    return (
        <SidebarGroup className={cn("", className)} {...props}>
            ...
            <SidebarMenu>
                {siteConfig.facultySidebar.map((item) => {
                            ...
                            <SidebarMenuItem>
                                <CollapsibleTrigger asChild>
                                    <SidebarMenuButton tooltip={item.title}>
                                        ...
                                        <Icons.CaretRight className="ml-auto transition-transform duration-200 group-data-[state=open]/collapsible:rotate-90" />
                                    </SidebarMenuButton>
                                </CollapsibleTrigger>
...
function SideUser() {
    const { useCurrentUser, useSignOut } = useFacultyAuth();
        ...
        <SidebarMenu>
            ...
            >
                {user ? (
                    <>
                        <Avatar className="size-8">
                            <AvatarImage
                                src={generateUploadThingURL(
                                    user.teacher.imageKey
                                )}
                        ...
                        <div className="grid flex-1 text-left text-sm leading-tight">
                            ...
                            <span className="truncate text-xs">Faculty</span>
                        </div>
                    </>
                ) : (
                    <>
                ...
                <button
                    ...
                    onClick={() => signOut({})}
                >
                    <Icons.SignOut className="ml-auto size-4" />
